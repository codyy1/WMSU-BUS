...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reset_password'])) {
    ...
    if (!$res || $res->num_rows === 0) {
        ...
        if ($upd->execute()) {
            ...
            $token_valid = false;
            echo '<div style="text-align:center; margin-top:20px;"><a href="index_user.php" class="button" style="display:inline-block; padding:10px 20px; background:#2563eb; color:#fff; text-decoration:none; border-radius:8px; font-weight:600;">Go to Login</a></div>';
        } else {
...
<head>
    <meta charset="UTF-8">
    <title>Reset Password - WMSU Transport</title>
